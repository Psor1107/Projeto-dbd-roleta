...
if os.listdir("data/perks/survivors_icons") == [] :
...
if os.listdir("data/perks/killer_icons") == []: 
...
if os.listdir("data/killers/icons") == []:
   project_repository = "https://raw.githubusercontent.com/Psor1107/Projeto-dbd-roleta/main/"
   ...
   for link in links:
      ...
      # add-ons agora se encontram em uma mesma página da Wiki
...
if os.listdir("data/survivors/icons") == []:
...
if os.listdir("data/items/icons") == []:
...
if os.listdir("data/items_add-ons/icons") == []:
...
if os.listdir("data/killers_add-ons/icons") == []:
   killer_addons_icon_path = "data/killers_add-ons/icons"
   killer_addons_html = urlopen("https://deadbydaylight.fandom.com/wiki/Add-ons").read()
   soup = BeautifulSoup(killer_addons_html, 'html.parser')
   killer_addons = get_killers_addons(soup, killer_addons_icon_path, project_repository)
   save_json("data/killers_add-ons/killers_add-ons.json", killer_addons)

print("Dados já existentes em disco")